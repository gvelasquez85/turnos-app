...
const HELP_CATEGORIES = [
  ...
  { key: 'productos', label: 'Productos e inventario', icon: '📦' },
  { key: 'colas', label: 'Colas de espera', icon: '🎫' },
  { key: 'citas', label: 'Citas y agenda', icon: '📅' },
  { key: 'encuestas', label: 'Encuestas de satisfaccion', icon: '⭐' },
  { key: 'menu', label: 'Menu digital', icon: '🍽️' },
  { key: 'comunicacion', label: 'Comunicaciones', icon: '💬' },
  { key: 'pqrs', label: 'PQRS', icon: '📋' },
  { key: 'copropiedades', label: 'Copropiedades', icon: '🏢' },
  { key: 'contabilidad', label: 'Contabilidad', icon: '📒' },
  { key: 'facturacion', label: 'Facturacion electronica', icon: '🧾' },
