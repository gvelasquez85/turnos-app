...
export const HELP_CATEGORIES: HelpCategory[] = [
  ...
  { key: 'productos', label: 'Productos e inventario', icon: '📦', description: 'Crea y administra tus productos y servicios' },
  { key: 'colas', label: 'Colas de espera', icon: '🎫', description: 'Gestiona turnos y filas de clientes en tu negocio' },
  { key: 'citas', label: 'Citas y agenda', icon: '📅', description: 'Administra citas, horarios y disponibilidad' },
  { key: 'encuestas', label: 'Encuestas de satisfaccion', icon: '⭐', description: 'Mide la satisfaccion de tus clientes' },
  { key: 'menu', label: 'Menu digital', icon: '🍽️', description: 'Crea tu menu digital y recibe pedidos en linea' },
  { key: 'comunicacion', label: 'Comunicaciones', icon: '💬', description: 'WhatsApp, email y notificaciones a clientes' },
  { key: 'pqrs', label: 'PQRS', icon: '📋', description: 'Gestiona peticiones, quejas, reclamos y sugerencias' },
  { key: 'copropiedades', label: 'Copropiedades', icon: '🏢', description: 'Administra conjuntos, cuotas, asambleas y mas' },
  { key: 'contabilidad', label: 'Contabilidad', icon: '📒', description: 'Registra ingresos, gastos y genera reportes contables' },
  { key: 'facturacion', label: 'Facturacion electronica', icon: '🧾', description: 'Genera facturas electronicas validas ante la DIAN' },
  { key: 'copilot', label: 'Copilot IA', icon: '🤖', description: 'Tu asistente de inteligencia artificial en TurnFlow' },
